...
Last updated: 2026-09-09. "Tested" means the listed path was exercised; it is not a certification claim.
...
| Windows 11 22H2/23H2 | Partial | Vault, TOTP, password generator, Windows Hello, and external WebAuthn work; native plugin provider requires 24H2+. |
| Windows 10 x64 | Partial | Desktop vault, TOTP, password generator, TPM 2.0 enclave, and external keys work; native passkey provider plugin requires Windows 11 24H2+. |
